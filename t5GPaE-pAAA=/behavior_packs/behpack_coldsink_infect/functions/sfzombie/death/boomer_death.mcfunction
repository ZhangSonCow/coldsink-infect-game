...
execute @s[tag=maper] ~~~ damage @e[family=player,family=!tool,type=!item,tag=!neutral,r=8] 4 suicide entity @s
execute @s[tag=maper] ~~~ damage @e[family=player,family=!tool,type=!item,tag=!neutral,r=5] 5 suicide entity @s
execute @s[tag=maper] ~~~ damage @e[family=player,family=!tool,type=!item,tag=!neutral,r=3] 6 suicide entity @s
...
execute @s[tag=!maper] ~~~ damage @e[tag=!boomer_dead,r=8] 4 suicide entity @s
execute @s[tag=!maper] ~~~ damage @e[tag=!boomer_dead,r=5] 5 suicide entity @s
execute @s[tag=!maper] ~~~ damage @e[tag=!boomer_dead,r=3] 6 suicide entity @s
