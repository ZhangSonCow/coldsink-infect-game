...
tag @s[tag=is_armor_tnnk] add back
title @s[scores={bool=1},tag=!is_armor_tnnk,tag=!is_tnnk,m=!c] actionbar §f已扮演 §6装甲泰坦
replaceitem entity @s[scores={bool=1},tag=!is_armor_tnnk,tag=!is_tnnk] slot.weapon.mainhand 1 coldsink:become_armor_tnnk 1 0 {"item_lock":{"mode":"lock_in_inventory"}}
tellraw @s[tag=!maper,scores={bool=1},tag=!is_armor_tnnk,tag=!is_tnnk] {"rawtext":[{"text":"§e再次使用变身器 §b即可恢复为人类"}]}

event entity @s[scores={bool=1},tag=!is_armor_tnnk,tag=!is_tnnk,m=!c] coldsink:become_armor_tnnk
title @s[tag=!maper,scores={bool=0},tag=!is_armor_tnnk,tag=!is_tnnk,m=!c] actionbar §b请令物品栏 §e第一、八、九格 §b与 §e盔甲栏 §b为空
title @s[tag=!is_armor_tnnk,tag=!is_tnnk,m=c] actionbar §f已扮演 §6装甲泰坦
tellraw @s[tag=!maper,scores={bool=0},tag=!is_armor_tnnk,tag=!is_tnnk,m=c] {"rawtext":[{"text":"§e再次使用变身器 §b即可恢复为人类"}]}
event entity @s[tag=!is_armor_tnnk,tag=!is_tnnk,m=c] coldsink:become_armor_tnnk
clear @s[tag=is_armor_tnnk,m=c] coldsink:become_armor_tnnk
give @s[tag=is_armor_tnnk,m=c] coldsink:become_armor_tnnk 1 0 {"item_lock":{"mode":"lock_in_inventory"}}
replaceitem entity @s[tag=is_armor_tnnk,m=c] slot.armor.head 1 air
replaceitem entity @s[tag=is_armor_tnnk,m=c] slot.armor.chest 1 air
replaceitem entity @s[tag=is_armor_tnnk,m=c] slot.armor.legs 1 air
replaceitem entity @s[tag=is_armor_tnnk,m=c] slot.armor.feet 1 air
...
event entity @s[tag=maper] coldsink:become_armor_tnnk
title @s[tag=maper] actionbar §f已扮演 §6装甲泰坦